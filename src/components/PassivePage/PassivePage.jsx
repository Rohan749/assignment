  ...
  return (
    <>
      <div className={classes.body}>
        <div data-aos="fade-up" data-aos-delay="300" className={classes.head}>EARN PASSIVE INCOME</div>
        <div data-aos="fade-up" data-aos-delay="500" className={classes.header}>Train GURU AI to Earn</div>
      ...
      <div className={classes.governancePage}>
        <div className={classes.page_left}>
          <img src={robo} className={classes.robo} height={200} data-aos="fade-up" data-aos-delay="300" />
          <div className={classes.headsection}>
            <h2>Streamlined decision making</h2>
          </div>
          <div className={classes.header} data-aos="fade" data-aos-delay="300" data-aos-anchor-placement="top-bottom">Your AI Governance Partner</div>
          <p className={classes.daigpara} data-aos="fade" data-aos-delay="300" data-aos-anchor-placement="top-bottom">
        ...
        <div className={classes.option_section}>
          <div className={classes.option_body} data-aos="fade-right" data-aos-delay="300" data-aos-anchor-placement="top-bottom">
            <img src={voting} />
            <div>Voting</div>
          </div>
          <div className={classes.option_body} data-aos="fade-right" data-aos-delay="400" data-aos-anchor-placement="top-bottom">
            <img src={stake} />
            <div>Staking</div>
          </div>
          <div className={classes.option_body} data-aos="fade-right" data-aos-delay="500" data-aos-anchor-placement="top-bottom">
            <img src={reward} />
      ...
      <div className={classes.tokenomics}>
        <div className={classes.header} data-aos="fade-up" data-aos-delay="500" data-aos-anchor-placement="top-bottom">TOKENOMICS</div>
        <div className={classes.tokenpara} data-aos="fade-up" data-aos-delay="500" data-aos-anchor-placement="top-bottom">
        ...
        <div className={classes.tokenBox} data-aos="fade-down" data-aos-delay="500" data-aos-anchor-placement="top-bottom">
